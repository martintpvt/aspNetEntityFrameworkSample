<%@ Page Title="" Language="C#" MasterPageFile="~/mstPrincipal.Master" AutoEventWireup="true" CodeBehind="frmReporteVentasTotales.aspx.cs" Inherits="CapaPresentacion.admin.frmReporteVentasTotales" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Contenido" runat="server">
    <div class="formulario span12 col-md-12">
        <div class="span12 col-md-12">
            <div class="span12 col-md-12">
                <label for="Contenido_ddlTiposLlanta">Reporte de ventas totales:</label>
            </div>
        </div>
        <div class="top-space span12 col-md-12">
            <div class="table-responsive">
                <asp:GridView ID="gvVentas" class="table table-bordered table-condensed table-striped" runat="server">
                </asp:GridView>
            </div>
        </div>
    </div>
