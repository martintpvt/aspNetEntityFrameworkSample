<%@ Page Title="" Language="C#" MasterPageFile="~/mstPrincipal.Master" AutoEventWireup="true" CodeBehind="frmReporteIngresosGastos.aspx.cs" Inherits="CapaPresentacion.admin.frmReporteIngresosGastos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Contenido" runat="server">
    <div class="formulario span12 col-md-12">
        <div class="span12 col-md-12">
            <div class="span12 col-md-12">
                <label for="Contenido_ddlTiposLlanta">Reporte de ingresos vs gastos:</label>
            </div>
        </div>
        <div class="top-space span12 col-md-12">
            <div class="table-responsive">
                <asp:GridView ID="gvIngresosVSGastos" class="table table-bordered table-condensed table-striped" runat="server">
                </asp:GridView>
            </div>
        </div>
    </div>
